...
{ 
	 public class VariableDetalleRepository : IVariableDetalleRepository 
	 { 
	 	 ...
	 	 { 
	 	 	 ...
	 	 	 DbCommand oDbCommand = oDatabase.GetStoredProcCommand("MOV.USP_SEL_VARIABLE_DETALLE_LISTAR"); 
	 	 	 try 
	 	 	 { 
        ...
        { 
	 	 ...
	 	 public AppResponse Mantenimiento(List<VariableDetalleLogic> lista, string accion) 
	 	 { 
	 	 	 try 
	 	 	 { 
	 	 	 	 DataTable dt = new DataTable(); 
	 	 	 	 List<VariableDetalle> listEntidad = lista.Cast<VariableDetalle>().ToList(); 
	 	 	 	 dt = Util.ConvertListToDatatable(listEntidad); 
	 	 	 	 SQLServer.OpenConection(); 
	 	 	 	 SQLServer.CreateCommand("MOV.USP_MANT_VARIABLE_DETALLE", CommandType.StoredProcedure, 
	 	 	 	 SQLServer.CreateParameter("ACCION", SqlDbType.VarChar, accion), 
	 	 	 	 SQLServer.CreateParameter("VARIABLE_DETALLE_TYPE", SqlDbType.Structured, dt));
	 	 	 	 using (IDataReader oReader = SQLServer.GetDataReader(CommandBehavior.CloseConnection))
	 	 	 	 { 
