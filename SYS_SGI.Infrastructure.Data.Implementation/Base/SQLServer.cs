...
namespace SYS_SGI.Infrastructure.Data.Implementation
{
    public class SQLServer
    {
        public const bool ConectionSIGPD = true;
        ...
        {
            return ConfigurationManager.ConnectionStrings["SYS_SGIDataBaseContext"].ConnectionString;
        }
